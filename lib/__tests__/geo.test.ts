...
describe('clusterEntriesByLocation', () => {
  ...
  it('lists every entry of a cluster, most recent first', () => {
    const clusters = clusterEntriesByLocation([
      { lat: 48.1173, lng: -1.6778, timestamp: '2026-01-01T10:00:00', photo_url: 'a.jpg', pseudo: 'Alice', counterEmoji: '🐾' },
      { lat: 48.1173, lng: -1.6778, timestamp: '2026-01-03T08:00:00', photo_url: null, pseudo: 'Bob', counterEmoji: '🔘' },
      { lat: 48.1173, lng: -1.6778, timestamp: '2026-01-02T10:00:00', photo_url: 'b.jpg', pseudo: 'Alice', counterEmoji: '🐾' },
    ]);
    expect(clusters).toHaveLength(1);
    expect(clusters[0].entries).toEqual([
      { timestamp: '2026-01-03T08:00:00', photoUrl: null, pseudo: 'Bob', counterEmoji: '🔘' },
      { timestamp: '2026-01-02T10:00:00', photoUrl: 'b.jpg', pseudo: 'Alice', counterEmoji: '🐾' },
      { timestamp: '2026-01-01T10:00:00', photoUrl: 'a.jpg', pseudo: 'Alice', counterEmoji: '🐾' },
    ]);
  });
});
